...
selenium.click("xpath=//div[@id='ato-form-wrapper']/div/button[3]")
selenium.click("id=ato-exame")
selenium.type("id=ato-exame", "Hemograma")
selenium.click("id=ato-obs")
selenium.type("id=ato-obs", "resumo")
selenium.click("id=ato-file")
selenium.click("id=ato-file")
selenium.click("id=btn-save-ato")
selenium.click("xpath=//li[@onclick='openReportModal(1780083789545)']")
