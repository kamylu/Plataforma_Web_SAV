...
selenium.click("xpath=//div[@id='ato-form-wrapper']/div/button[4]")
selenium.click("id=ato-cirurgia")
selenium.type("id=ato-cirurgia", ("Castração").toString())
selenium.click("id=ato-obs")
selenium.type("id=ato-obs", ("Lamber Feridas").toString())
selenium.click("id=ato-file")
selenium.click("id=ato-file")
selenium.click("id=btn-save-ato")
selenium.click("xpath=//li[@onclick='openReportModal(1780083902927)']")
