...
selenium.click("id=input-restricoes")
selenium.type("id=input-restricoes", ("Alergia severa a frango e picadas de pulga. Intolerância a anti-inflamatórios não esteroides (AINEs).\nOutras informações.").toString())
selenium.click("id=btn-save-info")
