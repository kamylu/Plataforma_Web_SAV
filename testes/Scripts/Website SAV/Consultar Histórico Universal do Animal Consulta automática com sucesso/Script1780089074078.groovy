...
selenium.click("xpath=//button[@id='btn-choose-vet']/div")
...
selenium.click("id=input-filter")
selenium.type("id=input-filter", "exame")
selenium.sendKeys("id=input-filter", Keys.ENTER)
selenium.type("id=input-filter", ("vacinação").toString())
selenium.sendKeys("id=input-filter", Keys.ENTER)
